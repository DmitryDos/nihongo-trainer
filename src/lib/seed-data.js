...
export const SEED_WORDS = [
  ...
  // --- ещё 50 нужных и простых глаголов (базовый обиход, N5–N4) ---
  { "kanji": "乗る", "kana": "のる", "russian": "садиться (в транспорт), ехать (на)", "pos": "verb" },
  { "kanji": "降りる", "kana": "おりる", "russian": "выходить (из транспорта), спускаться", "pos": "verb" },
  { "kanji": "", "kana": "くれる", "russian": "давать (мне, нам)", "pos": "verb" },
  { "kanji": "", "kana": "できる", "russian": "мочь, уметь; получаться", "pos": "verb" },
  { "kanji": "置く", "kana": "おく", "russian": "класть, ставить", "pos": "verb" },
  { "kanji": "捨てる", "kana": "すてる", "russian": "выбрасывать", "pos": "verb" },
  { "kanji": "頑張る", "kana": "がんばる", "russian": "стараться, держаться", "pos": "verb" },
  { "kanji": "掛かる", "kana": "かかる", "russian": "требоваться (о времени, деньгах); висеть", "pos": "verb" },
  { "kanji": "掛ける", "kana": "かける", "russian": "вешать; звонить (по телефону); надевать (очки)", "pos": "verb" },
  { "kanji": "止まる", "kana": "とまる", "russian": "останавливаться (о транспорте, механизме)", "pos": "verb" },
  { "kanji": "空く", "kana": "すく", "russian": "пустеть; проголодаться (お腹が〜)", "pos": "verb" },
  { "kanji": "渇く", "kana": "かわく", "russian": "хотеть пить (のどが〜); сохнуть", "pos": "verb" },
  { "kanji": "登る", "kana": "のぼる", "russian": "подниматься, взбираться", "pos": "verb" },
  { "kanji": "渡る", "kana": "わたる", "russian": "переходить, переправляться", "pos": "verb" },
  { "kanji": "通る", "kana": "とおる", "russian": "проходить, проезжать (через)", "pos": "verb" },
  { "kanji": "曲がる", "kana": "まがる", "russian": "поворачивать; гнуться", "pos": "verb" },
  { "kanji": "落ちる", "kana": "おちる", "russian": "падать, опадать", "pos": "verb" },
  { "kanji": "落とす", "kana": "おとす", "russian": "ронять; терять", "pos": "verb" },
  { "kanji": "向かう", "kana": "むかう", "russian": "направляться (куда-то)", "pos": "verb" },
  { "kanji": "浴びる", "kana": "あびる", "russian": "принимать (душ), обливаться", "pos": "verb" },
  { "kanji": "磨く", "kana": "みがく", "russian": "чистить (зубы), полировать", "pos": "verb" },
  { "kanji": "履く", "kana": "はく", "russian": "надевать (обувь, брюки)", "pos": "verb" },
  { "kanji": "脱ぐ", "kana": "ぬぐ", "russian": "снимать (одежду, обувь)", "pos": "verb" },
  { "kanji": "", "kana": "かぶる", "russian": "надевать (на голову), накрывать", "pos": "verb" },
  { "kanji": "焼く", "kana": "やく", "russian": "жарить, печь; жечь", "pos": "verb" },
  { "kanji": "沸かす", "kana": "わかす", "russian": "кипятить, греть (воду)", "pos": "verb" },
  { "kanji": "沸く", "kana": "わく", "russian": "кипеть, закипать", "pos": "verb" },
  { "kanji": "濡れる", "kana": "ぬれる", "russian": "мокнуть, намокать", "pos": "verb" },
  { "kanji": "汚れる", "kana": "よごれる", "russian": "пачкаться, загрязняться", "pos": "verb" },
  { "kanji": "並べる", "kana": "ならべる", "russian": "расставлять, раскладывать в ряд", "pos": "verb" },
  { "kanji": "伝える", "kana": "つたえる", "russian": "передавать (слова), сообщать", "pos": "verb" },
  { "kanji": "誘う", "kana": "さそう", "russian": "приглашать, звать (с собой)", "pos": "verb" },
  { "kanji": "謝る", "kana": "あやまる", "russian": "извиняться", "pos": "verb" },
  { "kanji": "褒める", "kana": "ほめる", "russian": "хвалить", "pos": "verb" },
  { "kanji": "断る", "kana": "ことわる", "russian": "отказывать, отклонять", "pos": "verb" },
  { "kanji": "思い出す", "kana": "おもいだす", "russian": "вспоминать", "pos": "verb" },
  { "kanji": "比べる", "kana": "くらべる", "russian": "сравнивать", "pos": "verb" },
  { "kanji": "慣れる", "kana": "なれる", "russian": "привыкать", "pos": "verb" },
  { "kanji": "迷う", "kana": "まよう", "russian": "заблудиться; колебаться", "pos": "verb" },
  { "kanji": "治る", "kana": "なおる", "russian": "выздоравливать, заживать", "pos": "verb" },
  { "kanji": "増える", "kana": "ふえる", "russian": "увеличиваться, прибавляться", "pos": "verb" },
  { "kanji": "減る", "kana": "へる", "russian": "уменьшаться, убывать", "pos": "verb" },
  { "kanji": "足りる", "kana": "たりる", "russian": "хватать, быть достаточным", "pos": "verb" },
  { "kanji": "無くす", "kana": "なくす", "russian": "терять, лишаться", "pos": "verb" },
  { "kanji": "無くなる", "kana": "なくなる", "russian": "пропадать, кончаться", "pos": "verb" },
  { "kanji": "投げる", "kana": "なげる", "russian": "бросать, кидать", "pos": "verb" },
  { "kanji": "拾う", "kana": "ひろう", "russian": "подбирать, поднимать", "pos": "verb" },
  { "kanji": "渡す", "kana": "わたす", "russian": "передавать, вручать", "pos": "verb" },
  { "kanji": "受ける", "kana": "うける", "russian": "получать; сдавать (экзамен)", "pos": "verb" },
  { "kanji": "", "kana": "やめる", "russian": "прекращать, бросать (дело); переставать", "pos": "verb" },
];
